...
export class PrismaMembershipUnitOfWork implements IMembershipUnitOfWork {
  ...
  constructor(private readonly prisma: PrismaService) {
    ...
    this._redemptions = new TransactionalMembershipCouponRedemptionRepository(
      prisma,
    );
 ...
 */
class TransactionalMembershipTierRepository
 ...
 */
class TransactionalMembershipCouponRepository
 ...
 */
class TransactionalMembershipCouponRedemptionRepository
 ...
 */
class TransactionalMembershipQuotaUsageRepository
