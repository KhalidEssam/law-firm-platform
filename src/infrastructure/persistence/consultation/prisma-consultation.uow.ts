 ...
 */
@Injectable()
export class PrismaConsultationUnitOfWork implements IConsultationRequestUnitOfWork {
    ...
    async transaction<T>(work: (uow: IConsultationRequestUnitOfWork) => Promise<T>): Promise<T> {
        const prismaOptions = toPrismaTransactionOptions(DEFAULT_TRANSACTION_OPTIONS);
    ...
    private createTransactionalUow(tx: PrismaTransactionClient): IConsultationRequestUnitOfWork {
        return {
            ...
            commit: async () => {},
            rollback: async () => {},
            transaction: async <R>(work: (uow: IConsultationRequestUnitOfWork) => Promise<R>): Promise<R> => {
...
class TransactionalConsultationRepository implements IConsultationRequestRepository {
    ...
    async create(consultation: ConsultationRequest): Promise<ConsultationRequest> {
        const data: Prisma.ConsultationRequestCreateInput = {
            ...
            slaStatus: consultation.slaStatus ? SLAStatusMapper.toPrisma(consultation.slaStatus) : undefined,
    ...
    async createMany(consultations: ConsultationRequest[]): Promise<ConsultationRequest[]> {
    ...
    async findByRequestNumber(requestNumber: RequestNumber): Promise<ConsultationRequest | null> {
        const result = await this.prisma.consultationRequest.findUnique({
    ...
    async findSLABreached(pagination?: PaginationParams): Promise<PaginatedResult<ConsultationRequest>> {
        return this.findAll({ slaStatus: ['breached'] }, pagination);
    }

    async findSLAAtRisk(pagination?: PaginationParams): Promise<PaginatedResult<ConsultationRequest>> {
    ...
    async getAll(filters?: ConsultationRequestFilters): Promise<ConsultationRequest[]> {
        const where = this.buildWhereClause(filters);
    ...
    async update(consultation: ConsultationRequest): Promise<ConsultationRequest> {
    ...
    async updateMany(consultations: ConsultationRequest[]): Promise<ConsultationRequest[]> {
    ...
    async updateStatus(id: ConsultationId, status: ConsultationStatusVO): Promise<ConsultationRequest> {
        const updated = await this.prisma.consultationRequest.update({
            where: { id: id.getValue() },
            data: {
    ...
    async getStatistics(filters?: ConsultationRequestFilters): Promise<any> {
        ...
        return { total, byStatus: {}, byUrgency: {}, bySLAStatus: {}, averageResponseTime: 0, averageCompletionTime: 0, slaBreachRate: 0 };
    }

    async groupByStatus(filters?: ConsultationRequestFilters): Promise<Record<ConsultationStatus, ConsultationRequest[]>> {
    ...
    async getProviderWorkload(providerId: UserId): Promise<number> {
        return this.prisma.consultationRequest.count({
            where: {
                assignedProviderId: providerId.getValue(),
                status: { in: [PrismaRequestStatus.assigned, PrismaRequestStatus.in_progress] },
                deletedAt: null,
            },
        });
    }

    private buildWhereClause(filters?: ConsultationRequestFilters): Prisma.ConsultationRequestWhereInput {
        ...
        if (filters.status) {
            ...
            where.status = { in: statuses.map(s => ConsultationStatusMapper.toPrisma(ConsultationStatusVO.create(s))) };
        }

        if (filters.slaStatus) {
            const slaStatuses = Array.isArray(filters.slaStatus) ? filters.slaStatus : [filters.slaStatus];
            where.slaStatus = { in: slaStatuses.map(s => SLAStatusMapper.toPrisma(SLAStatus.create(s))) };
        }
    ...
    private toDomain(data: any): ConsultationRequest {
        return ConsultationRequest.reconstitute({
            ...
            subscriberId: data.subscriberId ? UserId.create(data.subscriberId) : undefined,
            assignedProviderId: data.assignedProviderId ? UserId.create(data.assignedProviderId) : undefined,
...
class TransactionalStatusHistoryRepository implements IRequestStatusHistoryRepository {
    constructor(private readonly prisma: PrismaService | PrismaTransactionClient) {}
    ...
    async createMany(histories: RequestStatusHistory[]): Promise<RequestStatusHistory[]> {
    ...
    async findAll(
        ...
        const [data, total] = await Promise.all([
            this.prisma.requestStatusHistory.findMany({ where, skip, take: limit, orderBy: { changedAt: 'desc' } }),
            this.prisma.requestStatusHistory.count({ where }),
        ]);
    ...
    async getStatusTimeline(consultationId: ConsultationId): Promise<RequestStatusHistory[]> {
    ...
    private toDomain(data: any): RequestStatusHistory {
        return RequestStatusHistory.reconstitute({
            ...
            fromStatus: data.fromStatus ? ConsultationStatusVO.create(data.fromStatus) : undefined,
...
class TransactionalDocumentRepository implements IDocumentRepository {
    constructor(private readonly prisma: PrismaService | PrismaTransactionClient) {}
    async create(document: Document): Promise<Document> { return document; }
    async createMany(documents: Document[]): Promise<Document[]> { return documents; }
    async findById(id: DocumentId): Promise<Document | null> { return null; }
    async findByConsultationId(consultationId: ConsultationId): Promise<Document[]> { return []; }
    async findAll(filters?: DocumentFilters, pagination?: PaginationParams): Promise<PaginatedResult<Document>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async count(filters?: DocumentFilters): Promise<number> { return 0; }
    async exists(id: DocumentId): Promise<boolean> { return false; }
    async update(document: Document): Promise<Document> { return document; }
    async verify(id: DocumentId): Promise<Document> { throw new Error('Not implemented'); }
    async softDelete(id: DocumentId): Promise<boolean> { return true; }
    async softDeleteMany(ids: DocumentId[]): Promise<number> { return ids.length; }
    async hardDelete(id: DocumentId): Promise<boolean> { return true; }
    async hardDeleteMany(ids: DocumentId[]): Promise<number> { return ids.length; }
    async getTotalSize(consultationId: ConsultationId): Promise<number> { return 0; }
    async countByConsultation(consultationId: ConsultationId): Promise<number> { return 0; }
}

class TransactionalMessageRepository implements IRequestMessageRepository {
    constructor(private readonly prisma: PrismaService | PrismaTransactionClient) {}
    async create(message: RequestMessage): Promise<RequestMessage> { return message; }
    async createMany(messages: RequestMessage[]): Promise<RequestMessage[]> { return messages; }
    async findById(id: MessageId): Promise<RequestMessage | null> { return null; }
    async findByConsultationId(consultationId: ConsultationId, pagination?: PaginationParams): Promise<PaginatedResult<RequestMessage>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async findUnreadByConsultation(consultationId: ConsultationId): Promise<RequestMessage[]> { return []; }
    async findAll(filters?: MessageFilters, pagination?: PaginationParams): Promise<PaginatedResult<RequestMessage>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async count(filters?: MessageFilters): Promise<number> { return 0; }
    async update(message: RequestMessage): Promise<RequestMessage> { return message; }
    async markAsRead(id: MessageId): Promise<RequestMessage> { throw new Error('Not implemented'); }
    async markAllAsRead(consultationId: ConsultationId): Promise<number> { return 0; }
    async softDelete(id: MessageId): Promise<boolean> { return true; }
    async softDeleteMany(ids: MessageId[]): Promise<number> { return ids.length; }
    async hardDelete(id: MessageId): Promise<boolean> { return true; }
    async countUnread(consultationId: ConsultationId): Promise<number> { return 0; }
    async getLastMessage(consultationId: ConsultationId): Promise<RequestMessage | null> { return null; }
}

class TransactionalRatingRepository implements IRequestRatingRepository {
    constructor(private readonly prisma: PrismaService | PrismaTransactionClient) {}
    async create(rating: RequestRating): Promise<RequestRating> { return rating; }
    async findById(id: RatingId): Promise<RequestRating | null> { return null; }
    async findByConsultationId(consultationId: ConsultationId): Promise<RequestRating | null> { return null; }
    async findBySubscriberId(subscriberId: UserId, pagination?: PaginationParams): Promise<PaginatedResult<RequestRating>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async exists(consultationId: ConsultationId): Promise<boolean> { return false; }
    async update(rating: RequestRating): Promise<RequestRating> { return rating; }
    async hardDelete(id: RatingId): Promise<boolean> { return true; }
    async getAverageRatingForProvider(providerId: UserId): Promise<number> { return 0; }
    async countRatingsByProvider(providerId: UserId): Promise<number> { return 0; }
    async getRatingDistribution(providerId: UserId): Promise<Record<number, number>> { return {}; }
}

class TransactionalCollaboratorRepository implements IRequestCollaboratorRepository {
    constructor(private readonly prisma: PrismaService | PrismaTransactionClient) {}
    async create(collaborator: RequestCollaborator): Promise<RequestCollaborator> { return collaborator; }
    async createMany(collaborators: RequestCollaborator[]): Promise<RequestCollaborator[]> { return collaborators; }
    async findById(id: CollaboratorId): Promise<RequestCollaborator | null> { return null; }
    async findByConsultationId(consultationId: ConsultationId): Promise<RequestCollaborator[]> { return []; }
    async findByProviderUserId(providerUserId: ProviderUserId, pagination?: PaginationParams): Promise<PaginatedResult<RequestCollaborator>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async findAll(filters?: CollaboratorFilters, pagination?: PaginationParams): Promise<PaginatedResult<RequestCollaborator>> {
        return { data: [], pagination: { page: 1, limit: 10, total: 0, totalPages: 0, hasNext: false, hasPrevious: false } };
    }
    async exists(consultationId: ConsultationId, providerUserId: ProviderUserId): Promise<boolean> { return false; }
    async update(collaborator: RequestCollaborator): Promise<RequestCollaborator> { return collaborator; }
    async accept(id: CollaboratorId): Promise<RequestCollaborator> { throw new Error('Not implemented'); }
    async reject(id: CollaboratorId): Promise<RequestCollaborator> { throw new Error('Not implemented'); }
    async hardDelete(id: CollaboratorId): Promise<boolean> { return true; }
    async hardDeleteMany(ids: CollaboratorId[]): Promise<number> { return ids.length; }
    async countActiveCollaborators(consultationId: ConsultationId): Promise<number> { return 0; }
    async getCollaboratorsByRole(consultationId: ConsultationId, role: string): Promise<RequestCollaborator[]> { return []; }
}
