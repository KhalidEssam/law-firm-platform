...
export class HearingType {
  ...
  isFinalHearing(): boolean {
    return [HearingTypeEnum.VERDICT, HearingTypeEnum.APPEAL].includes(
      this.value,
    );
  }

  isPreparatoryHearing(): boolean {
    return [HearingTypeEnum.INITIAL, HearingTypeEnum.FOLLOW_UP].includes(
      this.value,
    );
  }
 ...
 */
export function mapHearingTypeFromPrisma(
 ...
 */
export function mapHearingTypeToPrisma(
