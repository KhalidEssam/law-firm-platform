 ...
 */
export function mapConsultationStatusToRequestStatus(
 ...
 */
export function mapRequestStatusToConsultationStatus(
 ...
 */
export function mapCallStatusToRequestStatus(
  callStatus: string,
): RequestStatusEnum {
  const mapping: Record<string, RequestStatusEnum> = {
 ...
 */
export function mapRequestStatusToCallStatus(
  requestStatus: RequestStatusEnum,
): CallStatusValue {
 ...
 */
export function mapCaseStatusToRequestStatus(
  caseStatus: string,
): RequestStatusEnum {
  const mapping: Record<string, RequestStatusEnum> = {
 ...
 */
export function mapRequestStatusToCaseStatus(
  requestStatus: RequestStatusEnum,
): CaseStatusValue {
 ...
 */
export function mapLegalOpinionStatusToRequestStatus(
 ...
 */
export function mapRequestStatusToLegalOpinionStatus(
  requestStatus: RequestStatusEnum,
): LegalOpinionStatusValue {
