...
export class NotificationPreference extends Entity<NotificationPreferenceProps> {
     ...
     */
    public static createDefaultsForUser(userId: string): NotificationPreference[] {
        const defaults: Array<{
            ...
            // Email preferences
            { channel: NotificationChannel.EMAIL, eventType: 'CONSULTATION_ASSIGNED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'CONSULTATION_COMPLETED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'OPINION_ASSIGNED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'OPINION_COMPLETED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'INVOICE_GENERATED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'PAYMENT_RECEIVED', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'SUBSCRIPTION_DUE', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'TICKET_REPLY', enabled: true },
            { channel: NotificationChannel.EMAIL, eventType: 'SYSTEM_ANNOUNCEMENT', enabled: true },

            // In-app preferences
            { channel: NotificationChannel.IN_APP, eventType: 'CONSULTATION_ASSIGNED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'CONSULTATION_UPDATED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'CONSULTATION_COMPLETED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'OPINION_ASSIGNED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'OPINION_STATUS_CHANGED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'OPINION_COMPLETED', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'REQUEST_MESSAGE', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'TICKET_REPLY', enabled: true },
            { channel: NotificationChannel.IN_APP, eventType: 'SYSTEM_ANNOUNCEMENT', enabled: true },

            // Push preferences
            { channel: NotificationChannel.PUSH, eventType: 'CONSULTATION_ASSIGNED', enabled: true },
            { channel: NotificationChannel.PUSH, eventType: 'REQUEST_MESSAGE', enabled: true },
            { channel: NotificationChannel.PUSH, eventType: 'TICKET_REPLY', enabled: true },

            // SMS preferences (disabled by default due to cost)
            { channel: NotificationChannel.SMS, eventType: 'SUBSCRIPTION_DUE', enabled: false },
            { channel: NotificationChannel.SMS, eventType: 'PAYMENT_FAILED', enabled: true },
        ];
...
export class UserNotificationPreferences {
    ...
    private constructor(userId: string, preferences: NotificationPreference[]) {
        ...
        this.preferences = new Map(
            preferences.map(p => [p.preferenceKey, p])
        );
    }

    public static fromList(userId: string, preferences: NotificationPreference[]): UserNotificationPreferences {
