...
export interface IAuditLogRepository {
     ...
     */
    findByUserId(userId: string, options?: AuditLogPaginationOptions): Promise<AuditLog[]>;
     ...
     */
    findByAction(action: string, options?: AuditLogPaginationOptions): Promise<AuditLog[]>;
