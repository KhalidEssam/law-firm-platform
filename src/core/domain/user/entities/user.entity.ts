...
export class User {
  ...
  get profession(): Profession | undefined {
    return this.props.profession;
  }
  get photo(): UserPhoto | undefined {
    return this.props.photo;
  }
  get ageGroup(): UserAgeGroup | undefined {
    return this.props.ageGroup;
  }
  get nationality(): Nationality | undefined {
    return this.props.nationality;
  }
  get employmentSector(): UserEmploymentSector | undefined {
    return this.props.employmentSector;
  }
  get profileStatus(): ProfileStatus {
    return this.props.profileStatus;
  }
  get loyaltyTier(): string | undefined {
    return this.props.loyaltyTier;
  }
  get subscriptionTier(): string | undefined {
