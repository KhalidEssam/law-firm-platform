...
import { CaseId, UserId, CaseStatus } from '../value-objects/litigation-case.vo';
...
export class LitigationStatusHistory {
     ...
     */
    static create(params: LitigationStatusHistoryCreateProps): LitigationStatusHistory {
     ...
     */
    static rehydrate(props: LitigationStatusHistoryRehydrateProps): LitigationStatusHistory {
        return new LitigationStatusHistory({
            ...
            fromStatus: props.fromStatus ? CaseStatus.create(props.fromStatus) : undefined,
