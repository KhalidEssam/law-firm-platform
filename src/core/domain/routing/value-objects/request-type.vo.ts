 ...
 */
export function getDefaultSLATimes(type: RequestType): { response: number; resolution: number } {
    const slaTimes: Record<RequestType, { response: number; resolution: number }> = {
