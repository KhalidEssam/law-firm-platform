...
export class RoutingConditions {
    ...
    private matchesCategory(category: string | null | undefined): boolean {
        ...
        return categories.map(c => c.toLowerCase()).includes(category.toLowerCase());
    }
    ...
    private matchesUrgency(urgency: string | null | undefined): boolean {
        ...
        return urgencies.map(u => u.toLowerCase()).includes(urgency.toLowerCase());
    }
    ...
    private matchesSubscriberTier(tier: string | null | undefined): boolean {
        ...
        return subscriberTiers.map(t => t.toLowerCase()).includes(tier.toLowerCase());
    }
    ...
    private matchesSpecializations(specializations: string[] | undefined): boolean {
    ...
    private evaluateCustomRule(rule: CustomRule, context: RequestContext): boolean {
 ...
 */
export function createRoutingConditions(data: RoutingConditionsData | null | undefined): RoutingConditions {
