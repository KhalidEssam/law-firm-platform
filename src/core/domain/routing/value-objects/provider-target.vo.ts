...
export class ProviderTarget {
    ...
    sortByLoadBalance(providers: ProviderInfo[]): ProviderInfo[] {
        return [...providers].sort((a, b) => a.activeRequestCount - b.activeRequestCount);
    }
    ...
    private matchesRegion(region: string | undefined): boolean {
        ...
        return targetRegions.map(r => r.toLowerCase()).includes(region.toLowerCase());
    }
 ...
 */
export function createProviderTarget(data: ProviderTargetData | null | undefined): ProviderTarget {
