...
export class ConfidentialityLevel {
  ...
  static create(
    value: ConfidentialityLevelEnum | string,
  ...
  static highlyConfidential(): ConfidentialityLevel {
    return new ConfidentialityLevel(
      ConfidentialityLevelEnum.HIGHLY_CONFIDENTIAL,
    );
  }

  static attorneyEyesOnly(): ConfidentialityLevel {
    return new ConfidentialityLevel(
      ConfidentialityLevelEnum.ATTORNEY_EYES_ONLY,
    );
  }
  ...
  getDescription(): string {
    const descriptions: Record<ConfidentialityLevelEnum, string> = {
      ...
      [ConfidentialityLevelEnum.CONFIDENTIAL]:
        'Additional confidentiality measures applied',
      [ConfidentialityLevelEnum.HIGHLY_CONFIDENTIAL]:
        'Strict access controls and encryption',
      [ConfidentialityLevelEnum.ATTORNEY_EYES_ONLY]:
        'Only assigned attorney can access',
    };
  ...
  requiresEncryption(): boolean {
    return (
      this.value === ConfidentialityLevelEnum.HIGHLY_CONFIDENTIAL ||
