...
export class LegalOpinionStatusHistory {
     ...
     */
    static create(params: LegalOpinionStatusHistoryCreateProps): LegalOpinionStatusHistory {
     ...
     */
    static rehydrate(props: LegalOpinionStatusHistoryRehydrateProps): LegalOpinionStatusHistory {
        return new LegalOpinionStatusHistory({
            id: StatusHistoryId.create(props.id),
            legalOpinionId: props.legalOpinionId,
            fromStatus: props.fromStatus ? (props.fromStatus as OpinionStatus) : undefined,
