...
export class MembershipChangeLog {
    ...
    isUpgrade(): boolean {
        return this.reason === MembershipChangeReason.UPGRADE ||
            (this.oldTierId !== null && this.newTierId !== null && this.newTierId > this.oldTierId);
    }

    /** Check if this is a tier downgrade */
    isDowngrade(): boolean {
        return this.reason === MembershipChangeReason.DOWNGRADE ||
            (this.oldTierId !== null && this.newTierId !== null && this.newTierId < this.oldTierId);
    }

    /** Check if this is a cancellation */
    isCancellation(): boolean {
        return this.reason === MembershipChangeReason.CANCELLATION ||
            (this.oldTierId !== null && this.newTierId === null);
    }

    /** Check if this is a reactivation */
    isReactivation(): boolean {
        return this.reason === MembershipChangeReason.REACTIVATION ||
            (this.oldTierId === null && this.newTierId !== null);
    }
