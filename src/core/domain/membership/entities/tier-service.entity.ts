...
export class TierService {
    ...
    updateQuota(props: {
        ...
        if (props.quotaPerMonth !== undefined) this.quotaPerMonth = props.quotaPerMonth;
        if (props.quotaPerYear !== undefined) this.quotaPerYear = props.quotaPerYear;
        if (props.rolloverUnused !== undefined) this.rolloverUnused = props.rolloverUnused;
