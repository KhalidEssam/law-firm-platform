...
export class SLATimes {
    ...
    private validate(): void {
        ...
        if (this.escalationTime !== null && this.escalationTime >= this.resolutionTime) {
     ...
     */
    toHours(): { responseHours: number; resolutionHours: number; escalationHours: number | null } {
        return {
     ...
     */
    toDays(): { responseDays: number; resolutionDays: number; escalationDays: number | null } {
        return {
