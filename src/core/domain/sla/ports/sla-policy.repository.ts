...
export interface ISLAPolicyRepository {
     ...
     */
    findByTypeAndPriority(requestType: RequestType, priority: Priority): Promise<SLAPolicy | null>;
     ...
     */
    findBestMatch(requestType: RequestType, priority?: Priority): Promise<SLAPolicy | null>;
     ...
     */
    existsByTypeAndPriority(requestType: RequestType, priority: Priority): Promise<boolean>;
}
