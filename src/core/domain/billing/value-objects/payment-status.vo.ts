...
export class PaymentStatus {
    ...
    isSuccessful(): boolean {
        return [PaymentStatusEnum.PAID, PaymentStatusEnum.PARTIALLY_REFUNDED].includes(this.value);
    }
    ...
    canBeRetried(): boolean {
        return [PaymentStatusEnum.PENDING, PaymentStatusEnum.FAILED].includes(this.value);
    }

    isFinal(): boolean {
        return [PaymentStatusEnum.REFUNDED, PaymentStatusEnum.FAILED].includes(this.value);
    }
