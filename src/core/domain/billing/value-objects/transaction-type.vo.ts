...
export class TransactionType {
    ...
    isCredit(): boolean {
        return [TransactionTypeEnum.WALLET_TOPUP, TransactionTypeEnum.REFUND].includes(this.value);
    }

    isDebit(): boolean {
        return [TransactionTypeEnum.SUBSCRIPTION, TransactionTypeEnum.SERVICE_PAYMENT].includes(this.value);
    }
