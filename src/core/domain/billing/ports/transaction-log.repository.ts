...
export interface ITransactionLogRepository {
    ...
    findSuccessfulTransactions(userId: string, fromDate?: Date, toDate?: Date): Promise<TransactionLog[]>;
    getUserTransactionSummary(userId: string, fromDate?: Date, toDate?: Date): Promise<TransactionSummary>;
    getTotalSpent(userId: string, fromDate?: Date, toDate?: Date): Promise<number>;
    getTotalRefunded(userId: string, fromDate?: Date, toDate?: Date): Promise<number>;
}
