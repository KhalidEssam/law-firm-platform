...
import { PaymentMethodId, UserId, PaymentMethodType } from '../value-objects/payment-method.vo';
...
export interface IPaymentMethodRepository {
    ...
    getStatistics(filters?: PaymentMethodFilters): Promise<PaymentMethodStatistics>;
