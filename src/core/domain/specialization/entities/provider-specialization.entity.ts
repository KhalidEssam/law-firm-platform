...
export class ProviderSpecialization extends AggregateRoot<ProviderSpecializationProps> {
    ...
    public static create(props: ProviderSpecializationProps, id?: string): ProviderSpecialization {
    ...
    public updateDetails(params: {
        ...
        if (params.experienceYears !== undefined) this.props.experienceYears = params.experienceYears;
        if (params.isCertified !== undefined) this.props.isCertified = params.isCertified;
        if (params.certifications !== undefined) this.props.certifications = params.certifications;
        if (params.caseCount !== undefined) this.props.caseCount = params.caseCount;
        if (params.successRate !== undefined) this.props.successRate = params.successRate;
        this.props.updatedAt = new Date();
    }
}
