...
export class NotificationIntegrationService {
  ...
  async notifyRoleAssigned(
    payload: RoleAssignmentNotificationPayload,
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send role assignment notification:',
        error,
      );
      return null;
    }
  ...
  async notifyRoleRemoved(
    payload: RoleRemovalNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send role removal notification:',
        error,
      );
      return null;
    }
  ...
  async notifyProfileUpdated(
    payload: ProfileUpdateNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send profile update notification:',
        error,
      );
      return null;
    }
  ...
  async notifyConsultationAssignedToSubscriber(
    payload: ConsultationAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send consultation assigned notification to subscriber:',
        error,
      );
      return null;
    }
  ...
  async notifyConsultationAssignedToProvider(
    payload: ConsultationAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send consultation assigned notification to provider:',
        error,
      );
      return null;
    }
  ...
  async notifyConsultationCompleted(
    payload: ConsultationCompletedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send consultation completed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyConsultationStatusChange(
    payload: ConsultationStatusChangeNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send consultation status change notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLegalOpinionAssignedToSubscriber(
    payload: LegalOpinionAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send legal opinion assigned notification to subscriber:',
        error,
      );
      return null;
    }
  ...
  async notifyLegalOpinionAssignedToLawyer(
    payload: LegalOpinionAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send legal opinion assigned notification to lawyer:',
        error,
      );
      return null;
    }
  ...
  async notifyLegalOpinionCompleted(
    payload: LegalOpinionCompletedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send legal opinion completed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLegalOpinionStatusChange(
    payload: LegalOpinionStatusChangeNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send legal opinion status change notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationCaseCreated(
    payload: LitigationCaseCreatedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send litigation case created notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationCaseAssignedToSubscriber(
    payload: LitigationCaseAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send case assigned notification to subscriber:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationCaseAssignedToProvider(
    payload: LitigationCaseAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send case assigned notification to provider:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationQuoteSent(
    payload: LitigationCaseQuoteSentNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send quote sent notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationQuoteAccepted(
    payload: LitigationCaseQuoteAcceptedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send quote accepted notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationPaymentReceived(
    payload: LitigationCasePaymentReceivedNotificationPayload,
  ): Promise<void> {
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send payment received notification to subscriber:',
        error,
      );
    }
    ...
    if (payload.providerId) {
      try {
        ...
        console.error(
          '[NotificationIntegration] Failed to send payment received notification to provider:',
          error,
        );
      }
    }
  ...
  async notifyLitigationCaseActivated(
    payload: LitigationCaseActivatedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send case activated notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationCaseClosed(
    payload: LitigationCaseClosedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send case closed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyLitigationCaseCancelled(
    payload: LitigationCaseCancelledNotificationPayload,
  ): Promise<void> {
    if (!this.sendNotificationUseCase) return;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send case cancelled notification to subscriber:',
        error,
      );
    }
    ...
    if (payload.providerId) {
      try {
        ...
        console.error(
          '[NotificationIntegration] Failed to send case cancelled notification to provider:',
          error,
        );
      }
    }
  ...
  async notifyLitigationRefundProcessed(
    payload: LitigationCaseRefundNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send refund processed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyCallRequestCreated(
    payload: CallRequestCreatedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;

    try {
      const dateStr =
        payload.preferredDate?.toLocaleDateString() || 'Not specified';
      return await this.sendNotificationUseCase.execute({
        userId: payload.subscriberId,
      ...
      console.error(
        '[NotificationIntegration] Failed to send call request created notification:',
        error,
      );
      return null;
    }
  ...
  async notifyCallRequestAssignedToSubscriber(
    payload: CallRequestAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call assigned notification to subscriber:',
        error,
      );
      return null;
    }
  ...
  async notifyCallRequestAssignedToProvider(
    payload: CallRequestAssignedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call assigned notification to provider:',
        error,
      );
      return null;
    }
  ...
  async notifyCallScheduled(
    payload: CallScheduledNotificationPayload,
  ): Promise<void> {
    if (!this.sendNotificationUseCase) return;

    const scheduledDateStr = payload.scheduledAt.toLocaleString();
    const callLinkInfo = payload.callLink
      ? ` Join link: ${payload.callLink}`
      : '';
    const callLinkInfoAr = payload.callLink
      ? ` رابط الانضمام: ${payload.callLink}`
      : '';
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call scheduled notification to subscriber:',
        error,
      );
    }
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call scheduled notification to provider:',
        error,
      );
    }
  }

  async notifyCallRescheduled(
    payload: CallRescheduledNotificationPayload,
  ): Promise<void> {
    if (!this.sendNotificationUseCase) return;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send reschedule notification to subscriber:',
        error,
      );
    }
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send reschedule notification to provider:',
        error,
      );
    }
  }

  async notifyCallReminder(
    payload: CallReminderNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call reminder notification:',
        error,
      );
      return null;
    }
  ...
  async notifyCallCompleted(
    payload: CallCompletedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send call completed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyCallCancelled(
    payload: CallCancelledNotificationPayload,
  ): Promise<void> {
    if (!this.sendNotificationUseCase) return;

    const cancelledByText =
      payload.cancelledBy === 'subscriber'
        ? 'you'
        : payload.cancelledBy === 'provider'
          ? 'the provider'
          : 'the system';
    const cancelledByTextAr =
      payload.cancelledBy === 'subscriber'
        ? 'أنت'
        : payload.cancelledBy === 'provider'
          ? 'مقدم الخدمة'
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send cancellation notification to subscriber:',
        error,
      );
    }
    ...
    if (payload.providerId) {
      try {
        ...
        console.error(
          '[NotificationIntegration] Failed to send cancellation notification to provider:',
          error,
        );
      }
    }
  ...
  async notifyCallNoShow(
    payload: CallNoShowNotificationPayload,
  ): Promise<void> {
    if (!this.sendNotificationUseCase) return;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send no-show notification to subscriber:',
        error,
      );
    }
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send no-show notification to provider:',
        error,
      );
    }
  }
  ...
  async notifyQuotaWarning(
    payload: QuotaWarningNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send quota warning notification:',
        error,
      );
      return null;
    }
  ...
  async notifyQuotaExceeded(
    payload: QuotaExceededNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send quota exceeded notification:',
        error,
      );
      return null;
    }
  ...
  async notifyMembershipExpiring(
    payload: MembershipExpiringNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send membership expiring notification:',
        error,
      );
      return null;
    }
  ...
  async notifyMembershipExpired(
    payload: MembershipExpiredNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send membership expired notification:',
        error,
      );
      return null;
    }
  ...
  async notifyMembershipTierChange(
    payload: MembershipTierChangeNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      return await this.sendNotificationUseCase.execute({
        userId: payload.userId,
        type: payload.isUpgrade
          ? NotificationType.MEMBERSHIP_UPGRADED
          : NotificationType.MEMBERSHIP_DOWNGRADED,
      ...
      console.error(
        '[NotificationIntegration] Failed to send membership tier change notification:',
        error,
      );
      return null;
    }
  ...
  async notifyInvoiceCreated(
    payload: InvoiceCreatedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send invoice created notification:',
        error,
      );
      return null;
    }
  ...
  async notifyInvoicePaid(
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send invoice paid notification:',
        error,
      );
      return null;
    }
  ...
  async notifyInvoiceOverdue(
    payload: InvoiceOverdueNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send invoice overdue notification:',
        error,
      );
      return null;
    }
  ...
  async notifyPaymentSuccess(
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send payment success notification:',
        error,
      );
      return null;
    }
  ...
  async notifyPaymentFailed(
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send payment failed notification:',
        error,
      );
      return null;
    }
  ...
  async notifyRefundProcessed(
    payload: RefundProcessedNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;
  ...
  async sendCustomNotification(
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send custom notification:',
        error,
      );
      return null;
    }
  ...
  async sendTemplatedNotification(
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send templated notification:',
        error,
      );
      return null;
    }
  ...
  async notifySLABreach(payload: SLABreachNotificationPayload): Promise<void> {
    ...
    try {
      ...
      console.error(
        '[NotificationIntegration] Failed to send SLA breach notification to subscriber:',
        error,
      );
    }
    ...
    if (payload.providerId) {
      try {
        ...
        console.error(
          '[NotificationIntegration] Failed to send SLA breach notification to provider:',
          error,
        );
      }
    }
  ...
  async notifySLAAtRisk(payload: SLAAtRiskNotificationPayload): Promise<void> {
    ...
    if (payload.providerId) {
      try {
        ...
        console.error(
          '[NotificationIntegration] Failed to send SLA at-risk notification to provider:',
          error,
        );
      }
    }
   ...
   */
  async notifySLADailyReport(
    payload: SLADailyReportNotificationPayload,
  ): Promise<Notification | null> {
    if (!this.sendNotificationUseCase) return null;

    try {
      const reportSummary =
        `Total Active: ${payload.summary.totalActive}, ` +
      ...
      console.error(
        '[NotificationIntegration] Failed to send SLA daily report notification:',
        error,
      );
      return null;
    }
