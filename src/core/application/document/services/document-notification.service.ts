...
import { DocumentRequestType, formatFileSize } from '../../../domain/document/value-objects/document.vo';
...
export class DocumentNotificationService {
    ...
    async notifyDocumentUploaded(
        ...
        if (!this.notificationService) {
            this.logger.log('Notification service not available, skipping document upload notification');
            return;
        }
    ...
    async notifyDocumentVerified(
        ...
        if (!this.notificationService) {
            this.logger.log('Notification service not available, skipping verification notification');
            return;
        }
        ...
        try {
            ...
            this.logger.error('Failed to send document verification notification:', error);
        }
    }
    ...
    async notifyDocumentRejected(
        ...
        if (!this.notificationService) {
            this.logger.log('Notification service not available, skipping rejection notification');
            return;
        }

        try {
            const payload = this.createPayload(document, { rejectedBy, rejectionReason: reason });
            ...
            this.logger.error('Failed to send document rejection notification:', error);
        }
    }
    ...
    async notifyVerificationPending(
        ...
        if (!this.notificationService) {
            this.logger.log('Notification service not available, skipping pending verification notification');
            return;
        }
        ...
        try {
            ...
            this.logger.error('Failed to send pending verification notification:', error);
        }
    }
    ...
    async notifyDocumentRequired(
        ...
        if (!this.notificationService) {
            this.logger.log('Notification service not available, skipping document required notification');
            return;
        }
        ...
        try {
            ...
            this.logger.error('Failed to send document required notification:', error);
        }
    }
