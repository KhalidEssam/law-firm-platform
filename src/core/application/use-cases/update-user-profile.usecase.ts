...
export class UpdateUserProfileUseCase {
    ...
    async execute(command: UpdateUserProfileCommand): Promise<User> {
        ...
        const updatedUser = user.updateProfile({
            ...
            biography: command.biography ? Biography.create(command.biography) : undefined,
            profession: command.profession ? Profession.create(command.profession) : undefined,
            photo: command.photo ? UserPhoto.create(command.photo) : undefined,
            ageGroup: command.ageGroup ? UserAgeGroup.create(command.ageGroup) : undefined,
            nationality: command.nationality ? Nationality.create(command.nationality) : undefined,
