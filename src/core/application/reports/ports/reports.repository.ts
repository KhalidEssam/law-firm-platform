...
export interface IReportRepository {
    ...
    findAll(filter?: ReportFilter, pagination?: ReportPaginationOptions): Promise<PaginatedReports>;
    findByType(type: ReportType, pagination?: ReportPaginationOptions): Promise<Report[]>;
    findByStatus(status: JobStatus, pagination?: ReportPaginationOptions): Promise<Report[]>;
    findByGeneratedBy(userId: string, pagination?: ReportPaginationOptions): Promise<Report[]>;
...
export interface IAnalyticsMetricRepository {
    ...
    findAll(filter?: MetricFilter, pagination?: MetricPaginationOptions): Promise<PaginatedMetrics>;
    findByName(metricName: string, timeRange?: TimeRange): Promise<AnalyticsMetric[]>;
    findByDimensions(dimensions: Partial<MetricDimensionsData>, timeRange?: TimeRange): Promise<AnalyticsMetric[]>;
