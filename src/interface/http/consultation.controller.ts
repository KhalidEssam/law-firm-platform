...
export class ConsultationRequestController {
    ...
    @ApiOperation({
        ...
        description: 'Get paginated list of consultation requests with optional filters'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Get all consultation requests assigned to the authenticated provider'
    })
    @ApiQuery({ name: 'page', required: false, type: Number })
    @ApiQuery({ name: 'limit', required: false, type: Number })
    @ApiResponse({
    ...
    @ApiOperation({
        ...
        description: 'Subscriber can dispute a completed consultation within 48 hours'
    })
    @ApiParam({ name: 'id', description: 'Consultation request ID' })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Batch update SLA statuses for all consultations. Typically called by cron job.'
    })
    @ApiResponse({
        status: 200,
