...
export class LitigationCaseController {
    ...
    @ApiResponse({ status: 400, description: 'Cannot accept - quote expired or invalid status' })
    async acceptQuote(
        @Param('id', ParseUUIDPipe) id: string,
        @CurrentUser() user: any,
    ): Promise<any> {
    ...
    @ApiResponse({ status: 400, description: 'Cannot cancel - invalid status or payment completed' })
    async cancel(
        @Param('id', ParseUUIDPipe) id: string,
        @Body() dto: any,
        @CurrentUser() user: any,
    ...
    @ApiResponse({ status: 400, description: 'Cannot send quote - invalid status' })
    async sendQuote(
        @Param('id', ParseUUIDPipe) id: string,
        @Body() dto: any,
        @CurrentUser() user: any,
    ...
    @ApiResponse({ status: 400, description: 'Cannot activate - payment not completed' })
    async activate(
        @Param('id', ParseUUIDPipe) id: string,
    ): Promise<any> {
    ...
    @ApiResponse({ status: 404, description: 'Case not found' })
    @ApiResponse({ status: 403, description: 'Forbidden - No access to this case' })
    async getById(
        @Param('id', ParseUUIDPipe) id: string,
        @CurrentUser() user: any,
    ): Promise<any> {
