...
export class SupportTicketController {
    ...
    @Roles('system admin', 'platform')
    @Permissions('read:support-tickets')
    async getUnassignedTickets(): Promise<{ tickets: SupportTicketResponseDto[] }> {
    ...
    @Roles('system admin', 'platform')
    @Permissions('read:support-tickets')
    async getHighPriorityTickets(): Promise<{ tickets: SupportTicketResponseDto[] }> {
    ...
    @Roles('system admin', 'platform')
    @Permissions('read:support-tickets')
    async getTicketsRequiringAttention(): Promise<{ tickets: SupportTicketResponseDto[] }> {
