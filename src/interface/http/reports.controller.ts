...
export class DashboardController {
    ...
    async getAdminSummary() {
        ...
        return {
            reports: reportStats,
            last30Days: {
                requestsCreated: Array.isArray(requestsCreated) ? requestsCreated : requestsCreated,
                requestsCompleted: Array.isArray(requestsCompleted) ? requestsCompleted : requestsCompleted,
            },
